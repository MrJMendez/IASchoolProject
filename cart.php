		...
		<div class="container">
			...
			<div class="row cart_items_row">
				<div class="col">
					...
					<?php
					$total = 0;
					$cartGetQuery = "SELECT * FROM carts WHERE customer_id = '$user'";
					$result = mysqli_query($conn, $cartGetQuery);
					$cart = mysqli_fetch_all($result);
					if(mysqli_query($conn, $cartGetQuery)){
						foreach ($cart as $c) {
						...
						<div class='cart_item_product d-flex flex-row align-items-center justify-content-start'>
							<div class='cart_item_image text-center'>
								<div><img src='Berthel-dev/".$c[8]."' width=80% alt=''></div>
							</div>
							<div class='cart_item_name_container'>
								<div class='cart_item_name'><a href='#'>".$c[4]."</a></div>
								<div class='cart_item_edit'><a href='#'>Edit Product</a></div>
							</div>
						</div>
						<!-- Price -->
						<div class='cart_item_price'>$".$c[6]."</div>
						<!-- Quantity -->
						<div class='cart_item_quantity'>
							<div class='product_quantity_container'>
								<div class='product_quantity clearfix'>
									<span>Qty</span>
									<input id='quantity_input' type='text' pattern='[0-9]*' value='".$c[7]."'>
						...
						<form name = 'del' method ='POST'>
							<button class='btn btn-primary btn-sm'name = 'delete' value = '".$c[0]."'>Delete</button>
							</form>
						<!-- Total -->
						<div class='cart_item_total'>$".$c[6]*$c[7]."</div>
					</div>";
					$total += $c[6]*$c[7];
							}
						}else{
...
<form name = 'cls' method ='POST'>

	<input type="submit" class="button continue_shopping_button" name = 'clear' value = 'Clear'>
			...
			<div class="row row_extra">
				<div class="col-lg-4">
					...
					<div class="delivery">
						...
						<div class="section_subtitle">One shipping option offered</div>
