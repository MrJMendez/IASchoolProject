<?php 
include('prosession.php');
include('signUp/register/prosetup.php');
							...
							<nav class="main_nav">
								<ul>
									...
									<li class="hassubs">
										...
										<li><a href="signUp/register/signUp.php">
										<?php if(isset($_SESSION['current_user'])): 
													echo $_SESSION['current_user'];
											?>
									<li><a href = "signUp/register/prologout.php" </a> Log out</li>
					...
					<div class="row">
						<div class="col">
							<div class="home_content">
								<div class="home_title">Featured Products<span>.</span></div>
								<div class="home_text"><p> A lot has changed in the world of technology in the last decade, so it's important to keep track of the latest technologies before making a purchase. With the extensive selection of electronic products available at HiQual, you can find the right product for you no matter your needs and preferences.</p></div>
							</div>
						</div>
					</div>
				</div>
