				...
				<div class="col-lg-6">
					<div class="billing checkout_section">
						...
						<div class="checkout_form_container">
							...
							<form action="#" method="POST" id="checkout_form" class="checkout_form" name="myform">
								<div class="row">
									<div class="col-xl-6">
										<!-- Name -->
									...
									<input type="phone" id="checkout_email" class="checkout_input" name="email" required="required">
									</div>
									<div class="col-xl-6">
										<!-- Name -->
								...
								<div>
									<!-- City / Town -->
									<label for="checkout_city">Post Office*</label>
									<input type ="text"  id="checkout_city" class="checkout_input" name="postoffice" require="required">
...
<?php   
			foreach($results as $r){
						...
						<div class="button order_button"><button name="order" value= "order"><a href="thankUpage.php">Place Order</a></button></div>
					</div>
				</div>
			</div>
		</div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></div>
						<div class="footer_social ml-lg-auto">
							<ul>
								...
								<li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
								<li><a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
								<li><a href="hiqual/admin/index.php"><i class="fa fa-user" aria-hidden="true"></i></a></li>
							</ul>
						</div>
					</div>
				</div>
