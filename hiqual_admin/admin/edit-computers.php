...
<head>
	...
	<title>HiQual Electronics | Admin Edit Computer Info</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Edit Computer</h2>
...
<?php $ret="select product_id, product_type from products ";
...
<div class="form-group">
<label class="col-sm-2 control-label">Computer Description<span style="color:red">*</span></label>
<div class="col-sm-10">
